...
def main():
    ...
    parser.add_argument('--job_platform',default='All', help='Specify the job_platform to fetch jobs, supported values are heavy / libvirt / powervs / upgrade')
    args = parser.parse_args()
    job_platform=args.job_platform.split(",")
